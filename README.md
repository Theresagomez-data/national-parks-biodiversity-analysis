...
## Data Source
- Original dataset: National Parks Species Dataset on Kaggle  
...
## Python Analysis / EDA
- All data cleaning, exploration, and visualizations were performed in Python  
- Notebook / script: [`notebooks/np_species_project.py`](notebooks/np_species_project.py)
